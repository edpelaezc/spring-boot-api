...
#sel_gen = ['Adventure', 'Action', 'Biography', 'Documentary']
sel_gen = sys.argv[1].split(',')
imdb_score = 8
...
table = KNN_Movie_Recommender(test_point, no_of_recommendations)
